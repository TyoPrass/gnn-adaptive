...
<head>
    ...
    <style>
        :root {
            ...
            --pretest-gradient: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="soal-management.php"><i class="fas fa-list-check me-2"></i>Soal Management</a></li>
                            <li><a class="dropdown-item" href="survey.php"><i class="fas fa-poll me-2"></i>Survey</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
